...
const Hero = () => {
  return (
    <div
      id="home"
      className="w-full h-screen mt-[-70px] bg-[url('https://wallpapers.com/images/hd/animated-space-1920-x-1229-background-unxl4ghmwz0vk0dh.jpg')] bg-cover flex flex-col"
    >
      <div className="pt-20 w-full h-full flex flex-col md:flex-row">
        ...
        <div className="h-full flex flex-[7] items-center p-10">
          <div className="w-full">
            <motion.h1
              variants={slideIn("spring", 0.5, 1.25)}
              initial="hidden"
              whileInView="show"
              className="lg:text-7xl md:text-6xl text-5xl font-extrabold mb-4"
            >
              Hi! I'm Cheikh Dime
            </motion.h1>
            <motion.p 
              variants={slideIn("spring", 0.75, 1.25)} 
              initial="hidden"
              whileInView="show"
              className="font-semibold lg:text-2xl md:text-xl text-lg text-gray-500 mr-12 mb-8">
              A Frontend focused Web Developer with knowledge and experience of
              Frontend, Backend, Cybersecurity, and more.
            </motion.p>
              ...
              <a href="#contact">
                <button className="relative group text-xl border-4 rounded-xl flex flex-row font-extrabold bg-transparent border-black px-4 py-3 text-black transition-colors before:absolute before:left-0 before:top-0 before:-z-10 before:h-full before:w-full before:origin-top-left before:scale-x-0 before:bg-black before:transition-transform before:duration-300 before:content-[''] hover:text-white before:hover:scale-x-100 z-0">
                  ...
                  <BsFillArrowRightSquareFill
                    size={28}
                    className="text-[#0A0D38] ml-4 group-hover:text-white duration-300"
                  />
                </button>
              </a>
            </div>
        ...
        <div className="flex flex-[7] h-full items-center justify-center">
          <img
            src={Astronaut}
            className="aspect-square md:w-[415px] sm:w-[300px] w-[250px] sm:mb-0 mb-10 hero-image"
          />
        </div>
      </div>
